package com.timofeenkoprojects.tutorbot.service.manager.auth;
...
import static com.timofeenkoprojects.tutorbot.service.data.CallbackData.AUTH_TEACHER;
import static com.timofeenkoprojects.tutorbot.service.data.CallbackData.AUTH_STUDENT;
        ...
        try {
            bot.execute(
                    methodFactory.getAnswerCallbackQuery(
                            callbackQuery.getId(),
                            """
                                    Авторизация прошла успешно, повторите предфдущий запрос!"""
                    ));
